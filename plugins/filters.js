...
Asena.addCommand({on: 'text', fromMe: false}, (async (message, match) => {
    if (message.jid.includes(Config.YAK)) {
        ...
        if (!!message.mention && message.mention[0] == '918593938626@s.whatsapp.net') {
...
const array = ['Ayin','Ayinu','Bgm','Bot','Bye','Da','Good night','Hello','Hi','Neymar','Bi','Sed','Ok','assist','Kozhapam','delete','Choodavalle','converting','fake','fork','fuck','music','myre','njan','number','oombi','para','poda','raganork','remove','reply','sed','subscribe','umma','xxxtentation']
array.map( async (a) => {
